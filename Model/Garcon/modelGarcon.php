...
class controlGarcon {
	...
	$dataAtual = strval(date('d/m/Y - H:i'));
        ...
        VALUES ('".$_SESSION['idEmpresa']."' ,'$this->nomeDoCliente','$this->descricao' ,'$this->observacao' , '$this->preco' ,  $this->troco ,'$this->formaDePagamento' , '$this->formaDeEntrega' , '$this->endereco' ,'$this->numero' , '$this->bairro' ,'$this->complemento' ,'$this->pontoDeReferencia' , '$this->estado' , '$this->cidade' , '$this->telefone' ,'$dataAtual', 'Novo')";
