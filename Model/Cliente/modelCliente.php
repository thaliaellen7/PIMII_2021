...
class controlCliente {
	...
	public function cadastrarPedido () {
		...
		$dataAtual = strval(date('d/m/Y - H:i'));
			...
			VALUES ($this->idEmpresa ,'$this->nomeDoCliente','$this->descricaoPedido' ,'$this->observacao' , '$this->preco' , $this->troco ,'$this->formaDePagamento' , '$this->formaDeEntrega' , '$this->endereco' ,'$this->numero' , '$this->bairro' ,'$this->complemento' ,'$this->pontoDeReferencia' , '$this->estado' , '$this->cidade' , '$this->telefone' ,'$dataAtual', 'Novo')";
