...
/* 
    ...
    public function editarFuncionario () {
		$s = "UPDATE funcionario SET `nome`= '$this->nome', `email`= '$this->email', `cargo`= '$this->cargo', `salario`= $this->salario,`endereco`= '$this->endereco', `numero`= $this->numero, `bairro`= '$this->bairro', `complemento`= '$this->complemento', `pontoDeReferencia`= '$this->pontoDeReferencia', `estado`= '$this->estado',`cidade`= '$this->cidade', `telefone`= '$this->telefone' WHERE idFuncionario = $this->idFuncionario";
		$resultado = $this->conexao->atualizar($s);
		$this->conexao->encerrar();
		return $resultado;
	}
