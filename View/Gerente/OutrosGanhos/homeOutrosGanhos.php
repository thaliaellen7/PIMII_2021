					...
					<table>
						...
						<?php foreach (controlOutrosGanhos::listarGanhos() as $fila) { ?>
								<tr>
									...
									<td class="column1"><a href="editGanho.php?idGanho=<?=base64_encode($fila[0])?>"><img width="30px" src="../../../img/editar-arquivo.png"/></a></td>
									<td><a href="../../../Control/Gerente/OutrosGanhos/controlOutrosGanhos.php?a=excluir&idGanho=<?=base64_encode($fila[0])?>" onclick="return confirm('Deletar Ganho?')"><img width="30px" src="../../../img/excluir.png"/></a></td>
								</tr>
								<?php } ?>
						</tbody>
					</table>
