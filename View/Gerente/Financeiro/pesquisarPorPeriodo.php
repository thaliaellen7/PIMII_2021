...
print "<h4>Gasto Total com outros setores (R$) | $outros reais |</h4"; $outros = 0 ;$tituloOutros = 0;}
...
</div>';  print "<h4>Ganho Total com outros setores (R$) | $outrosGanhos reais |</h3"; $tituloOutrosGanhos = 0;?>
    <br>
   ...
   <?php  echo '  	<div class="limiter">
    ...
    <br>
    <br> 
    <?php $saldogasto = $outros+$produtos; $saldoganho = $pedidos+$outrosGanhos; $bruto = $saldoganho - $saldogasto;
    echo '<div class="limiter">
    <div class="container-table100">
        <div class="wrap-table100">
            <div class="table100">
                <table>
                    ...
                    <tbody>
                            <tr>
                                ...
                                <td class="column1">'.$saldoganho.'</td>
                                <td class="column1">'.$bruto.'</td>
                            </tr>
                    </tbody>
                </table>
            </div>
