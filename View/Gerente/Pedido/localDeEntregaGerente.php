...
<header class="site-header">
      <div class="wrapper site-header__wrapper">
        <a href="#" class="brand"><img id="logo" 
                    ...
                    ></a>
        <nav class="nav">
		<a href="../Pedido/homePedido.php"><button class="nav__toggle_2" aria-expanded="false" type="button">
		  <img
				width="25px"
				src="../../../img/back.png"
					class="active-item"
          ...
          <ul class="nav__wrapper">
            <li class="nav__item"><a href="../Pedido/homePedido.php">
			<img
				width="70px"
				src="../../../img/back.png"
					class="active-item"
					...
					<table>
						...
						<tbody>
								<tr>
									...
									<td class="column2"><?= $rol[10] ?></td>
									<td class="column3"><?= $rol[11] ?></td>
									<td class="column4"><?= $rol[12] ?></td>
									<td class="column6"><?= $rol[13] ?></td>
									<td class="column6"><?= $rol[14] ?></td>
									<td class="column6"><?= $rol[15] ?></td>
									<td class="column6"><?= $rol[16] ?></td>
								</tr>
						</tbody>
					</table>
				</div>
